...
namespace TwitchLeecher.Gui.Views
{
    public partial class TwitchConnectView : UserControl
    {
        ...
        private void Chrome_IsBrowserInitializedChanged(object sender, DependencyPropertyChangedEventArgs e)
        {
            ...
            {
                chrome.Load("https://id.twitch.tv/oauth2/authorize?client_id=37v97169hnj8kaoq8fs3hzz8v6jezdj&redirect_uri=http://www.tl.com&response_type=token&scope=user:read:subscriptions&force_verify=true");
            }
        }
    }
}